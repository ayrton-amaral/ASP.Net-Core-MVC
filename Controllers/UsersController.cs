...
namespace PropertyRentalManagement.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            roles.Add("Owner");
            roles.Add("Manager");
            ViewData["roles"] = new SelectList(roles, user.Role);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,TreatmentPronoun,FirstName,LastName,Email,Username,Password,Role")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Search(string role)
        {
            ...
            var filteredUsers = await _context.Users.Where(u => u.Role == role).ToListAsync();
